...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'dbredernitz';//this will be your WCC username
      $dbUsr = 'dbredernitz';//this will be your WCC username
      $dbPass = 'Vj7qbG4F9xQh';//this will be the password found in the video.
